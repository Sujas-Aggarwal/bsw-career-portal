import resourceImage1 from './Image/Resource.jpg'; // Replace with the correct file name
import resourceImage2 from './Image/HR.jpg'; // Replace with the correct file name
import resourceImage3 from './Image/interview.jpg'; // Replace with the correct file name
